...
- Hotkey integration: Ctrl+Alt+Space toggles real recording
...
**Goal**: Register a global hotkey (Ctrl+Alt+Space) that toggles placeholder recording state.
...
- Hotkey integration: Ctrl+Alt+Space updates WorkflowState on start/stop
