...
- Hotkey integration: Cmd+Shift+S toggles real recording
...
**Goal**: Register a global hotkey (Cmd+Shift+S) that toggles placeholder recording state.
...
- Hotkey integration: Cmd+Shift+S updates WorkflowState on start/stop
