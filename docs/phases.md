...
- Hotkey integration: Cmd+Option+. toggles real recording
...
**Goal**: Register a global hotkey (Cmd+Option+.) that toggles placeholder recording state.
...
- Hotkey integration: Cmd+Option+. updates WorkflowState on start/stop
