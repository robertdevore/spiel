...
- Press **Ctrl+Alt+Space** to start recording (or click the **Start Recording** button)
- A live elapsed timer appears while recording
- Press **Ctrl+Alt+Space** again to stop (or click **Stop Recording**)
...
- **Hotkey**: Change the global shortcut (default: Ctrl+Alt+Space)
...
Another app may be using Ctrl+Alt+Space. Change the shortcut in Settings.
