...
- ✅ **Global hotkey: Ctrl+Alt+Space** toggles real microphone recording
...
| Hotkeys | Tauri global shortcut plugin (Ctrl+Alt+Space) |
...
- [ ] Pressing Ctrl+Alt+Space toggles state between Idle and Recording
