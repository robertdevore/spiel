...
- ✅ **Global hotkey: Alt+Shift+Space** toggles real microphone recording
...
| Hotkeys | Tauri global shortcut plugin (Alt+Shift+Space) |
...
- [ ] Pressing Alt+Shift+Space toggles state between Idle and Recording
